...
// Option 5: Steel blue black (keeps both sides in the same universe)
const THEME = {
  left: {
    bg: "radial-gradient(1200px 900px at 25% 30%, #102033 0%, #080C12 60%, #050607 100%)",
  },
  right: {
    bg: "radial-gradient(1200px 900px at 75% 35%, #0A1320 0%, #05070C 62%, #030307 100%)",
  },
  accent: "#FF6A2B",
};
...
export default function HomeOption5() {
  return (
    <main className="min-h-[100dvh] bg-[#050405] text-white relative overflow-hidden flex flex-col">
      <motion.header
