...
// Theme E: Neutral Charcoal + Cold Blue, Electric Blue Accent
const THEME = {
  left: {
    bg: "radial-gradient(1200px 900px at 25% 30%, #121418 0%, #07080A 60%, #040405 100%)",
  },
  right: {
    bg: "radial-gradient(1200px 900px at 75% 35%, #0A1022 0%, #05060B 65%, #030307 100%)",
  },
  accent: "#4C8DFF",
};
...
export default function HomeV3E() {
  return (
    <main className="min-h-[100dvh] bg-[#030307] text-white relative overflow-hidden flex flex-col">
      <motion.header
