...
// Theme B: Navy + Violet, Orange Accent
const THEME = {
  left: {
    bg: "radial-gradient(1200px 900px at 25% 30%, #0E2431 0%, #070D12 60%, #050608 100%)",
  },
  right: {
    bg: "radial-gradient(1200px 900px at 75% 35%, #160E24 0%, #08060C 60%, #050408 100%)",
  },
  accent: "#FF6A2B",
};
...
export default function HomeV3B() {
  return (
    <main className="min-h-[100dvh] bg-[#050408] text-white relative overflow-hidden flex flex-col">
      <motion.header
