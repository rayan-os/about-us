...
// Theme C: Graphite + Emerald, Orange Accent
const THEME = {
  left: {
    bg: "radial-gradient(1200px 900px at 20% 35%, #0D2C1F 0%, #07110C 60%, #050605 100%)",
  },
  right: {
    bg: "radial-gradient(1200px 900px at 75% 40%, #0B0C0B 0%, #060606 65%, #030303 100%)",
  },
  accent: "#FF6A2B",
};
...
export default function HomeV3C() {
  return (
    <main className="min-h-[100dvh] bg-[#030303] text-white relative overflow-hidden flex flex-col">
      <motion.header
