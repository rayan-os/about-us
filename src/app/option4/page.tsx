...
// Option 4: Deep emerald black (pairs with navy nicely)
const THEME = {
  left: {
    bg: "radial-gradient(1200px 900px at 25% 30%, #102033 0%, #080C12 60%, #050607 100%)",
  },
  right: {
    bg: "radial-gradient(1200px 900px at 75% 35%, #071C17 0%, #050A09 60%, #030404 100%)",
  },
  accent: "#FF6A2B",
};
...
export default function HomeOption4() {
  return (
