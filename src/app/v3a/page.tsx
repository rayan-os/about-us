...
// Theme A: Deep Teal + Black, Orange Accent
const THEME = {
  left: {
    bg: "radial-gradient(1200px 800px at 20% 30%, #0B3A3C 0%, #061A1D 55%, #05080A 100%)",
  },
  right: {
    bg: "radial-gradient(1200px 900px at 70% 40%, #0B0B0D 0%, #050507 70%, #030304 100%)",
  },
  accent: "#FF6A2B",
};
...
export default function HomeV3A() {
  return (
    <main className="min-h-[100dvh] bg-[#030304] text-white relative overflow-hidden flex flex-col">
      <motion.header
